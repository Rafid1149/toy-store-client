...
const Register = () => {
    ...
    const { createUser, signInWithGoogle, setLoading } =
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div className=" text-center">
                                <button
                                    ...
                                    type="button"
                                    className="text-white bg-gradient-to-r from-purple-400 to-purple-800 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-purple-400 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                                >
